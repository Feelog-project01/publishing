...
document.addEventListener("DOMContentLoaded", () => {
    ...
    document.querySelectorAll(".MuiInput-input").forEach((input) => {
        ...
        input.addEventListener("focus", (e) => {
            console.log(e.target.closest(".joy-k54e1s").querySelector(".joy-i4zyc6").classList);
        ...
        // 포커스가 옮겨지고, 입력값이 올바르지 못 할 경우 경우 빨간색으로 표시
...
{
    /* <div class="MuiFormControl-root MuiFormControl-vertical MuiFormControl-sizeMd joy-k54e1s">
	<label for=":r0:" id=":r0:-label" class="MuiFormLabel-root joy-11hmm2q">이메일</label>
	<div class="MuiInput-root MuiInput-variantOutlined MuiInput-colorNeutral MuiInput-sizeMd MuiInput-formControl joy-i4zyc6">
		<input id=":r0:" placeholder="이메일" class="MuiInput-input joy-1u0jcuo" type="email" name="email">
	</div>
</div>

<div class="MuiFormControl-root MuiFormControl-vertical Mui-error MuiFormControl-sizeMd joy-k54e1s">
	<label for=":r0:" id=":r0:-label" class="MuiFormLabel-root joy-11hmm2q">이메일</label>
	<div class="MuiInput-root MuiInput-variantOutlined MuiInput-colorDanger MuiInput-sizeMd Mui-error MuiInput-formControl joy-f7n8og">
		<input id=":r0:" placeholder="이메일" class="MuiInput-input joy-1u0jcuo" type="email" name="email" aria-invalid="true" aria-describedby=":r0:-helper-text">
	</div>
	<div aria-live="assertive" class="MuiFormHelperText-root joy-7l9mu1" id=":r0:-helper-text">이메일을 입력해 주세요.</div>
</div> */
}
