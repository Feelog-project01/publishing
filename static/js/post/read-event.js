...
const scrapButtons = document.querySelectorAll(".joy-td9vav");
const likeButtons = document.querySelectorAll(".joy-fsdjpg");
    ...
    postButton.addEventListener("click", (e) => {
        ...
        <ul role="menu" tabindex="-1" id=":r2l:" class="base-Popper-root MuiMenu-root Mui-expanded MuiMenu-variantPlain MuiMenu-colorNeutral MuiMenu-sizeMd joy-oqjr4q" style="" data-popper-placement="bottom-start">
            <a tabindex="-1" id=":r2p:" role="menuitem" class="MuiMenuItem-root MuiMenuItem-colorNeutral MuiMenuItem-variantPlain joy-1nwwb6p">
                <p class="MuiTypography-root MuiTypography-body-md joy-rdn5wq">신고하기</p>
            </a>
        </ul>
        `;
            div.innerHTML = text;
...
scrapButtons.forEach((button) => {
    button.addEventListener("click", (e) => {
        ...
        if (svg.classList.contains("joy-155e7hk")) {
            svg.classList.remove("joy-155e7hk");
...
likeButtons.forEach((button) => {
    button.addEventListener("click", (e) => {
        ...
        if (svg.classList.contains("joy-1nsw94h")) {
            svg.classList.remove("joy-1nsw94h");
        ...
        if (svg.classList.contains("joy-4rp8fm")) {
            svg.classList.remove("joy-4rp8fm");
