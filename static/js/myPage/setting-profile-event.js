...
document.addEventListener("DOMContentLoaded", () => {
    ...
    document.querySelector("#\\:R559uuukv9ul7rlqakq\\:").addEventListener("focus", (e) => {
        e.target.closest(".joy-128w9vm").classList.toggle("Feelog-focused");
    });
    ...
    document.querySelector("#\\:R759uuukv9ul7rlqakq\\:").addEventListener("focus", (e) => {
        e.target.closest(".joy-1bm8vhn").classList.toggle("Feelog-focused");
    });
    ...
    document.querySelector(".joy-1bvc4cc .flog-button-10").addEventListener("click", (e) => {
        e.preventDefault();
